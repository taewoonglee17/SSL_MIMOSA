...
dpath       = '/autofs/space/marduk_003/users/yohan/data/qalas/100824_bay2_invivo/nifti/';
b1path      = '/autofs/space/marduk_003/users/yohan/data/qalas/100824_bay2_invivo/nifti/';
...
input_img   = single(niftiread([dpath,'img_cs_denoised_NOopt_correctHeader_meas_MID00928_FID203897_tfl_3d_qalas_TE60ms_highres_v0']));
...
if load_b1_map == 1
    ...
    B1_map = single(niftiread([b1path,'b1map_medfilt5_2qalas.nii.gz']));
    B1_map = flip(permute(B1_map,[2,1,3]),1);
    load([b1path,'b1map_medfilt5_2qalas_afi_scale_factor.mat']);
    if b1_type == 1
...
bmask = single(niftiread([b1path,'bet_mask_correctHeader_meas_MID00928_FID203897_tfl_3d_qalas_TE60ms_highres_v0.nii']));
