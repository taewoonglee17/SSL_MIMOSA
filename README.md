...
This is the official code for **`"SSL-MIMOSA: Self-Supervised Learning for Fast Multiparameter Estimation Including T₂* Mapping in Quantitative MRI with MIMOSA"`**, presented at [ISMRM 2026](https://echo.ismrm.org/program/ISMRM2026/at-a-glance/session/794) Abstract #360-04-008.
